...
UserAgents = [
    ...
    10_6_8; en-us) AppleWebKit/534.50 (KHTML, \
    like Gecko) Version/5.1 Safari/534.50',

    'Mozilla/5.0 (Windows; \
    U; Windows NT 6.1; en-us) AppleWebKit/534.50 (\
    KHTML, like Gecko) Version/5.1 Safari/534.50',

    'Mozilla/5.0 (compatible; MSIE 9.0; W\
    indows NT 6.1; Trident/5.0;',

    'Mozilla/4.0 \
    (compatible; MSIE 8.0; Windows \
    NT 6.0; Trident/4.0)',
    ...
    'Mozilla/5.0 (Windows NT 6.1; rv,2.0.1) \
    ...
    OS X 10_7_0) AppleWebKit/535.11 (KHTML, like Gecko) \
    Chrome/17.0.963.56 Safari/535.11',


    'Mozilla/4.0 (compatible; MSIE 7.0; \
    Windows NT 5.1; Maxthon 2.0)',


    'Mozilla/4.0 (compatible; MSIE 7.0; \
    Windows NT 5.1; The World)',


    'Mozilla/4.0 (compatible; MSIE 7.0; \
    Windows NT 5.1; Trident/4.0; SE 2.X MetaSr 1.0; SE \
    2.X MetaSr 1.0; .NET CLR 2.0.50727; SE 2.X MetaSr 1.0)',
